...
\chapter{Pemanggilan Library Big Number} \label{sec:bn_func_call}
...
\VerbatimInput[label=\fbox{dh.txt}]{resources/text/bn_grep/grep_result_dh.txt}

\paragraph{RSA}
Modul RSA pada OpenSSL terdapat pada direktori |openssl/crypto/rsa|

\VerbatimInput[label=\fbox{rsa.txt}]{resources/text/bn_grep/grep_result_rsa.txt}
