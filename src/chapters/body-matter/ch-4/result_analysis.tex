%!TEX root = ../resources/csv/../resources/csv/../resources/csv/tugas-akhir.tex
\section{Evaluasi}
    ...
    \subsubsection{Hasil dan Analisis Pengujian}
      ...
      \begin{figure}[h]
        ...
        \begin{tikzpicture}
          \begin{axis}[
            ...
            \addplot[color=gray, discard if not={opr}{add}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/bn1_add.csv};
            \addlegendentry{local-1cpu}
            \addplot[color=blue, discard if not={opr}{add}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/bn1_add.csv};
            \addlegendentry{local-2cpu}
            \addplot[color=red, discard if not={opr}{add}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/do/bn1_add.csv};
            \addlegendentry{do-1cpu}
            \addplot[color=green, discard if not={opr}{add}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/do/bn2_add.csv};
      ...
      \begin{figure}[h]
        ...
        \begin{tikzpicture}
            ...
            \addplot[color=gray, discard if not={opr}{mul}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/bn2_mul.csv};
            \addlegendentry{local-1cpu}
            \addplot[color=blue, discard if not={opr}{mul}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/bn1_mul.csv};
            \addlegendentry{local-2cpu}
            \addplot[color=red, discard if not={opr}{mul}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/do/bn1_mul.csv};
            \addlegendentry{do-1cpu}
            \addplot[color=green, discard if not={opr}{mul}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/do/bn2_mul.csv};
            \addlegendentry{do-4cpu}
          \end{axis}
        \end{tikzpicture}
        \caption{Data Perkalian}
        \label{fig:data_mul}
      \end{figure}
      ...
      \begin{figure}[h]
        ...
        \begin{tikzpicture}
            ...
            \addplot[color=gray, discard if not={opr}{div}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/bn2_div.csv};
            \addlegendentry{local-1cpu}
            \addplot[color=blue, discard if not={opr}{div}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/bn1_div.csv};
            \addlegendentry{local-2cpu}
            \addplot[color=red, discard if not={opr}{div}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/do/bn1_div.csv};
            \addlegendentry{do-1cpu}
            \addplot[color=green, discard if not={opr}{div}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/do/bn2_div.csv};
            \addlegendentry{do-4cpu}
          \end{axis}
        \end{tikzpicture}
      ...
      \begin{figure}[h]
        ...
        \begin{tikzpicture}
            ...
            \addplot[color=gray, discard if not={opr}{modmul}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/bn2_modmul.csv};
            \addlegendentry{local-1cpu}
            \addplot[color=blue, discard if not={opr}{modmul}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/bn1_modmul.csv};
            \addlegendentry{local-2cpu}
            \addplot[color=red, discard if not={opr}{modmul}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/do/bn1_modmul.csv};
            \addlegendentry{do-1cpu}
            \addplot[color=green, discard if not={opr}{modmul}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/do/bn2_modmul.csv};
            \addlegendentry{do-4cpu}
          \end{axis}
        \end{tikzpicture}
      ...
      \begin{figure}[h]
        ...
        \begin{tikzpicture}
            ...
            \addplot[color=gray, discard if not={opr}{modexp}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/bn2_modexp.csv};
            \addlegendentry{local-1cpu}
            \addplot[color=blue, discard if not={opr}{modexp}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/bn1_modexp.csv};
            \addlegendentry{local-2cpu}
            \addplot[color=red, discard if not={opr}{modexp}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/do/bn1_modexp.csv};
            \addlegendentry{do-1cpu}
            \addplot[color=green, discard if not={opr}{modexp}] table [x=tc_num, y=time_avg, col sep=comma] {./resources/csv/do/bn2_modexp.csv};
            \addlegendentry{do-4cpu}
          \end{axis}
        \end{tikzpicture}
