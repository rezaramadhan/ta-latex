    ...
    \subsubsection{Hasil dan Analisis Pengujian}
      ...
      \begin{figure}[h]
        ...
        \begin{tikzpicture}
          \begin{axis}[
            ...
            \addplot[color=blue, discard if not={opr}{add}] table [x=tc_num, y=time_avg, col sep=comma] {resources/csv/bn_add.csv};
      ...
      \begin{figure}[h]
        ...
        \begin{tikzpicture}
            ...
            \addplot[color=blue, discard if not={opr}{mul}] table [x=tc_num, y=time_avg, col sep=comma] {resources/csv/bn_mul.csv};
          \end{axis}
        \end{tikzpicture}
      ...
      \begin{figure}[h]
        ...
        \begin{tikzpicture}
            ...
            \addplot[color=blue, discard if not={opr}{div}] table [x=tc_num, y=time_avg, col sep=comma] {resources/csv/bn_div.csv};
          \end{axis}
        \end{tikzpicture}
      ...
      \begin{figure}[h]
        ...
        \begin{tikzpicture}
            ...
            \addplot[color=blue, discard if not={opr}{modmul}] table [x=tc_num, y=time_avg, col sep=comma] {resources/csv/bn_modmul.csv};
          \end{axis}
        \end{tikzpicture}
      ...
      \begin{figure}[h]
        ...
        \begin{tikzpicture}
            ...
            \addplot[color=blue, discard if not={opr}{modexp}] table [x=tc_num, y=time_avg, col sep=comma] {resources/csv/bn_modexp.csv};
          \end{axis}
        \end{tikzpicture}
